...
public class Window extends JFrame implements Runnable {
    ...
    public Window(){
        ...
        leftScoreText = new Text(leftScore, new Font("Times New Roman", Font.PLAIN, Constants.TEXT_SIZE), Constants.TEXT_X_POS,Constants.TEXT_Y_POS);
        rightScoreText = new Text(rightScore, new Font("Times New Roman", Font.PLAIN, Constants.TEXT_SIZE), Constants.SCREEN_WIDTH - Constants.TEXT_X_POS - 16, Constants.TEXT_Y_POS);
        ...
        aiController = new Ai(new PlayerController(ai),ballRect);
